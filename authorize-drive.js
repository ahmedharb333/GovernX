...
(async () => {
  ...
  const server = http.createServer(async (req, res) => {
    ...
    try {
      ...
      res.end("<h2>✅ GovernX Drive authorized.</h2><p>Refresh token saved. You can close this tab and return to the terminal.</p>");
  ...
  server.listen(PORT, () => {
    console.log("\n────────────────────────────────────────────────────────────────");
    console.log("  GovernX Drive authorization");
    console.log("────────────────────────────────────────────────────────────────");
